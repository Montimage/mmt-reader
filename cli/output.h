 ...
 * including protocol tables (with/without paths) and input
 * statistics.  Separates presentation concerns from the core
 * engine so the engine API stays clean and output can be
