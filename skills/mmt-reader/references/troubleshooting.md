...
- **Live capture prints its stats block twice** in text mode — cosmetic; the two blocks carry the same figures. Packet counts, duration, bandwidth and pps are recorded on the live path as they are offline.
